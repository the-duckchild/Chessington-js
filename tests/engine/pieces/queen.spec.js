...
describe('Queen', () => {
      ...
      describe("White Queen", () => {
        ...
        it('can move laterally', () => {
            ...
            const expectedMoves = [
                // Horizontal
                Square.at(2, 0), Square.at(2, 1), Square.at(2, 3), Square.at(2, 4), Square.at(2, 5), Square.at(2, 6), Square.at(2, 7),
                // Vertical
                Square.at(0, 3), Square.at(2, 3), Square.at(3, 3), Square.at(4, 3), Square.at(5, 3), Square.at(6, 3), Square.at(7, 3)
            ];
        ...
        it("cannot move at the top of the board", () => {
            const queen = new Queen(Player.WHITE);
            board.setPiece(Square.at(7, 3), queen);
